...
const PostFooter: React.FC<PostFooterProps> = ({ liked, likesCount, handleLike, favorited, favoritesCount, handleFavorite, showLoginPopup, setShowLoginPopup, post_id, user_id, onNewComment, commentCount }) => {
  ...
  return (
   ...
   {!showCommentPopup ? (
    ...
    <button className="flex items-center p-1 pr-3 gap-1" onClick={handleCommentClick}>
        ...
        <span className="text-xs inline-block w-4 text-center"> {commentCount} </span>
    </button>
