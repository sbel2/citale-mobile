...
const PostFooter: React.FC<PostFooterProps> = ({ liked, likesCount, handleLike, favorited, favoritesCount, handleFavorite, showLoginPopup, setShowLoginPopup }) => {
  ...
  return (
   ...
   {!showCommentPopup ? (
        <input
          ...
          onFocus={() => setShowCommentPopup(true)}
        />
      ) : (
    ...
    <button className="flex items-center p-1 pr-3 gap-1" onClick={() => setShowCommentPopup(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
